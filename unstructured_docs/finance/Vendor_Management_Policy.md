...
## Overview
This policy establishes guidelines for vendor selection, management, and evaluation to ensure cost-effectiveness, quality service delivery, and risk mitigation across PremiumFiber Communications' technology partnerships.
...
- Integration capability with PremiumFiber platforms
...
|--------|------------------|----------|-----------------|
| Microsoft | €15M | Fibra Platform | Gold Partner |
...
|--------|------------------|----------|
| Orange Wholesale | €5M | Tier 1 Connectivity |
| Win Business | €2.5M | Network Infrastructure |
...
| Vendor | Annual Commitment | Category |
|--------|------------------|----------|
| Broadsoft (Cisco) | €3M | Fibra Platform |
| Enghouse | €1.5M | Contact Centre |
| Akixi | €500K | Analytics & Reporting |
| PremiumFiber Mobile (internal) | €2M | Mobile Services |
...
| Orange Wholesale | March 2025 | Operations Director |
...
- Spain Telecoms Security Act compliance for network vendors
