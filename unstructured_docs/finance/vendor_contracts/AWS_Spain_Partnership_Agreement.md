# AWS Spain Partnership Agreement
**PremiumFiber Communications PLC - Cloud Infrastructure Partner**
...
| Parties | PremiumFiber Communications PLC / Amazon Web Services EMEA SARL |
...
| Service | Description | PremiumFiber Use Case |
|---------|-------------|----------------|
...
|---------|---------------|--------------|
| Amazon Connect | Per minute + subscribers | €150K |
...
| Connect instances | 25 live | Spain region |
| Voice integration | Complete | SIP to PremiumFiber |
...
| Data Residency | Spain only | Compliant |
...
| Component | PremiumFiber Responsibility |
|-----------|---------------------|
...
| Connect Specialist | €40K/year | AW€Partner |
...
| Webinar series | Quarterly | PremiumFiber-led |
...
- All data processed in AWS Madrid (eu-west-2)
- No data transfer outside Spain without consent
