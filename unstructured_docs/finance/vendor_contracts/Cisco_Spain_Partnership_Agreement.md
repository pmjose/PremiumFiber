# Cisco Spain Partnership Agreement
**PremiumFiber Communications PLC - Technology Alliance**
...
| Parties | PremiumFiber Communications PLC / Cisco Systems Spain Ltd |
...
| Requirement | PremiumFiber Commitment |
|-------------|------------------|
| SIP interconnect | Maintain certified |
| Codec support | Full suite |
| Emergency services | Spain compliant |
...
| Level | Cisco Contact | PremiumFiber Contact |
|-------|---------------|---------------|
| 1 | TAC | NOC |
...
| GDPR | Compliant | Both |
| Spain Telecom | Licensed | PremiumFiber |
