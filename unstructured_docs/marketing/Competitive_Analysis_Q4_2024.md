...
| Metric | Value | PremiumFiber Position |
|--------|-------|----------------|
...
|----------|-----------------|----------|----------|
| **PremiumFiber (Starface/Placetel)** | Rising Top 5 | Premium + Digital, owned IP | Integration phase |
...
#### PremiumFiber Positioning vs Telefónica España

| Factor | Telefónica España | PremiumFiber | Advantage |
|--------|-----|-------|-----------|
...
**Opportunity:** Target top 50 Telefónica España partners for recruitment
...
| Factor | Orange España | PremiumFiber | Advantage |
|--------|-------------|-------|-----------|
| Channel commitment | Low | High | **PremiumFiber** |
| SMB/Mid-Market | Deprioritised | Core focus | **PremiumFiber** |
| Enterprise | Strong | Developing | Orange España |
| Brand | Strong | Growing (FTSE 250) | Mixed |
| Pricing | Premium | Competitive | **PremiumFiber** |

**Key Message:** "Channel-first, never competing with partners"

**Opportunity:** SMB/Mid-Market partners seeking alternatives
...
- **Financial Concerns:** Debt restructuring continues
- **Cloud Platform:** MiCloud losing to cloud-native solutions
- **Partner Base:** Legacy partners actively exploring alternatives
- **Product Investment:** Limited vs competitors
- **Merger Speculation:** Continues in industry press

#### PremiumFiber Positioning vs Mitel

| Factor | Mitel | PremiumFiber | Advantage |
|--------|-------|-------|-----------|
| Cloud platform | Legacy | Native | **PremiumFiber** |
| Financial stability | Weak | **FTSE 250** | **PremiumFiber** |
| Partner trust | Declining | Strong | **PremiumFiber** |
| Feature innovation | Limited | Strong | **PremiumFiber** |
| Future viability | Uncertain | Clear | **PremiumFiber** |

**Key Message:** "Cloud-native platform, secure long-term future"

**Opportunity:** Migration programme for Mitel partner/customer base
...
#### PremiumFiber vs Microsoft Direct

| Factor | MS Direct | PremiumFiber + Teams | Advantage |
|--------|-----------|---------------|-----------|
| Call quality | Variable | Carrier-grade | **PremiumFiber** |
| Support | Tiered | Dedicated | **PremiumFiber** |
| Advanced features | Basic | Advanced voice | **PremiumFiber** |
| Partner delivery | No | Yes | **PremiumFiber** |
| Pan-European | Complex | Single solution | **PremiumFiber** |
...
| Reason | Frequency | Change |
|--------|-----------|--------|
| Microsoft Teams preference | 38% | ↑ |
| Price (vs cheaper option) | 24% | ↑ |
| Enterprise features | 16% | ↓ |
| Incumbent relationship | 13% | → |
| Brand awareness | 9% | ↓ |
...
2. **Mitel Migration Programme**
   - Target: Partners with large MiVoice installed bases
   - Message: Cloud-native future, secure platform
   - Programme: Replacement toolkit, training

3. **Microsoft Differentiation**
   - Message: Enterprise voice + partner delivery
   - Products: Operator Connect International, AI features
   - Campaign: "Better together than direct"
...
1. **NFON Challenge**
   ...
   - Focus: Partner recruitment from NFON
